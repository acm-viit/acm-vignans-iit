...
import Team2025 from './team/Team2025';
        ...
        <div>
            <div className="tabs gap-8">
                <div className='border-b border-gray-200 dark:border-neutral-700'>
                    ...
                    <motion.button
                            className={`px-[12px] p-[2px] rounded-full ${activeTab === '2025' ? 'active bg-dark/85 dark:bg-light dark:text-dark text-light font-semibold' : 'bg-gray-200 dark:bg-light/15 text-gray-700 dark:text-light'}`}
