...
const CategoryPage = ({ blogs, allCategories, currentSlug }) => {
  ...
  return (
    <>
      <Head>
        <title>{currentSlug} | Categories | ACM Vignan&apos;s IIT | Association for Computing Machinery Vignan&apos;s Institute of Information Technology - Visakhapatna</title>
      ...
      <article className="min-h-screen flex flex-col text-dark dark:text-light">
        <div className="px-10 sm:px-8 md:px-24 flex flex-col">
