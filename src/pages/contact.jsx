...
const Contact = () => {
  return (
    <>
      <Head>
        <title>Contact Us | ACM Vignan&apos;s IIT | Association for Computing Machinery Vignan&apos;s Institute of Information Technology - Visakhapatna</title>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-1 items-center gap-16 p-8 mx-auto max-w-4xl bg-light dark:bg-dark  border sm:border-0 border-dark dark:border-light rounded-md text-dark dark:text-light font-[sans-serif]">
              ...
              <div className="mt-12">
                ...
                <ul className="mt-3">
                  <li className="flex items-center">
                    <div className="bg-[#e6e6e6cf] dark:bg-[#242424] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
            ...
            <form className="ml-auo space-y-4">
              <input type='text' placeholder='Name'
                className="w-full rounded-md py-2.5 px-4 border text-sm outline-[#007bff] bg-[#f2f2f2] dark:bg-[#242424]" />
              <input type='email' placeholder='Email'
                className="w-full rounded-md py-2.5 px-4 border text-sm outline-[#007bff] bg-[#f2f2f2] dark:bg-[#242424]" />
              <input type='text' placeholder='Subject'
                className="w-full rounded-md py-2.5 px-4 border text-sm outline-[#007bff] bg-[#f2f2f2] dark:bg-[#242424]" />
              <textarea placeholder='Message' rows="6"
                className="w-full rounded-md px-4 border text-sm pt-2.5 outline-[#007bff] bg-[#f2f2f2] dark:bg-[#242424]"></textarea>
              <button type='button'
                className="text-white bg-[#007bff] hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full">Send Message</button>
            </form>
          </div>
        </div>
      </main>
